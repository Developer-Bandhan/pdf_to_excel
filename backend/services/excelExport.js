...
async function excelExport(rows, tokenUsage = null) {
  ...
  productSheet.columns = [
    ...
    { header: "DIA", key: "DIA", width: 18 },
    { header: "Length 1 (cm)", key: "length_cm", width: 14 },
    { header: "Length 2 (cm)", key: "length_2_cm", width: 14 },
    { header: "Length 3 (cm)", key: "length_3_cm", width: 14 },
    ...
    { header: "Finish Code", key: "finish_code", width: 20 },
    ...
    { header: "Additional Price (Lowest)", key: "additional_price_lowest", width: 18 },
    { header: "Additional Price (Highest)", key: "additional_price_highest", width: 18 },
